...
Route::namespace($namespace)->group(function () {
  ...
  Route::get('bakery-soft/install/packages', [BakerySoftController::class, 'packages'])->name('packages');
  Route::get('bakery-soft/generate-crud', [BakerySoftController::class, 'loadCrud'])->name('load.crud');

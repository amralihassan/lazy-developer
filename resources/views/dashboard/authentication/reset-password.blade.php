                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-9 col-xl-8">
                                    ...
                                    <div class="card p-4 page-content">
                                        <div class="card-body page-single-content">
                                            <div class="w-100">
                                                ...
                                                <p class="text-muted">{{ __('Reset Password Page') }}</p>
                                                <form method="POST" action="{{ route('admin.password.update') }}">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email" name="email" value="{{ old('email') }}" class="form-control" placeholder="Enter Password">
                                                    </div>
                                                    @error('email')
                                                    ...
                                                    <div class="row mt-4">
                                                        <div class="col-12">
                                                            <button type="button" class="btn  btn-lg btn-primary btn-block px-4"><i class="fe fe-arrow-right"></i> {{ __('Reset Password') }}</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                ...
                                <div class="text-center pt-4">
                                    <div class="font-weight-normal fs-16">Forget it <a class="btn-link font-weight-normal" href="{{ route('admin.login') }}">Send me back</a></div>
                                </div>
                            </div>
                        </div>
                    </div>

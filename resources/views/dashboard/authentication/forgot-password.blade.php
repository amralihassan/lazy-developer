                                    ...
                                    <div class="card p-4 page-content">
                                        <div class="card-body page-single-content">
                                            <div class="w-100">
                                                ...
                                                <p class="text-muted">{{ __('Forgot Password Page') }}</p>
                                                <hr class="my-6">
                                                <form method="POST" action="{{ route('admin.password.email') }}">
                                                    ...
                                                    <div class="row mt-4">
                                                        <div class="col-12">
                                                            <button class="btn btn-lg btn-primary btn-block px-4"><i class="fe fe-arrow-right"></i> {{ __('Email Password Reset Link') }}</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>

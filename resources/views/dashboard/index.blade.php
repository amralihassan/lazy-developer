...
@section('page-header')
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title">@lang('app.Sales_Dashboard')</h4>
        </div>
        <div class="page-rightheader ml-auto d-lg-flex d-none">
            <div class="ml-5 mb-0">
                <a class="btn btn-white date-range-btn" href="#" id="daterange-btn">
                    ...
                    </svg> <span>Select Date <i class="fa fa-caret-down"></i></span>
                </a>
            </div>
        </div>
    </div>
                    ...
                    <div class="h-400 scrollbar2" id="scrollbar2">
                        <div class="table-responsive">
                            <table class="table transaction-table mb-0 text-nowrap">
                                ...
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="../../assets/images/orders/11.jpg" alt="media1"> New Headset</td>
                                    <td>#561527167</td>
                                    <td>11th July, 10am</td>
                                    <td class="font-weight-bold">$13,206</td>
                                    <td><span class="badge badge-danger badge-pill">Declined</span></td>
                                ...
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="../../assets/images/orders/14.jpg" alt="media1"> New Modal shoe</td>
                                    <td>#12323423</td>
                                    <td>11th July, 10am</td>
                                    <td class="font-weight-bold">$13,206</td>
                                    <td><span class="badge badge-primary badge-pill">Completed</span></td>
                                ...
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3" src="../../assets/images/orders/5.jpg" alt="media1"> Branded Shoes</td>
                                    <td>#26762768</td>
                                    <td>11th July, 10am</td>
                                    <td class="font-weight-bold">$13,206</td>
                                    <td><span class="badge badge-warning badge-pill">Pending</span></td>
                    ...
                    <div class="h-400 scrollbar3" id="scrollbar3">
                        <div class="table-responsive">
                            <table class="table transaction-table mb-0">
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img class="w-7 h-7 rounded shadow mr-3" src="../../assets/images/users/1.jpg" alt="media1">
                                        <div class="mt-2">
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img class="w-7 h-7 rounded shadow mr-3" src="../../assets/images/users/4.jpg" alt="media1">
                                        <div class="mt-2">
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img class="w-7 h-7 rounded shadow mr-3" src="../../assets/images/users/5.jpg" alt="media1">
                                        <div class="mt-2">
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img class="w-7 h-7 rounded shadow mr-3" src="../../assets/images/users/2.jpg" alt="media1">
                                        <div class="mt-2">
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img class="w-7 h-7 rounded shadow mr-3" src="../../assets/images/users/10.jpg" alt="media1">
                                        <div class="mt-2">
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img class="w-7 h-7 rounded shadow mr-3" src="../../assets/images/users/12.jpg" alt="media1">
                                        <div class="mt-2">

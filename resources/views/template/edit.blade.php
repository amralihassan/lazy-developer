            ...
            <div class="row">
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1"><a class="te"
                            href="{{ route($route_cancel, $parent_id) }}">{{ $main_title }}</a></li>
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-horizontal" id="frm" action="{{ route($route_update, $id) }}"
                                ...
                                <div class="pull-right">
                                    <div class="col-12 d-flex flex-sm-row flex-column">
                                        @if(isset($edit) && $edit)
                                            <button type="submit"
                                                class="btn btn-primary glow mb-1 mr-sm-1">Save changes
                                            </button>
                                        @endif

...
Route::get('bakerysoft/install/packages', [BakerySoftController::class, 'packages']);
Route::get('bakerysoft/generate-crud', [BakerySoftController::class, 'loadCrud']);
Route::post('bakerysoft/generate', [BakerySoftController::class, 'generate'])->name('generate');
